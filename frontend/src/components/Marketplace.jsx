...
import CerebroCorporativoModule from './modules/Marketplace/CerebroCorporativoModule.jsx';
import ControllistaModule from './modules/Marketplace/ControlListaModule.jsx';
import IntelligenceHubModule from './modules/Marketplace/IntelligenceHubModule.jsx';
...
const MODULE_COLORS = {
    ...
    cerebrocorporativo:    '#3B82F6',
    controllista:          '#DC2626',
    intelligencehub:       '#06B6D4',
};
            ...
            */}
            ...
            <div className="container mx-auto lg:px-6" style={{ position: 'relative', zIndex: 1 }}>
                ...
                >
                    ...
                    {/* Cerebro Corporativo - Azul */}      
                    <div
                        ref={(el) => (moduleRefs.current['cerebrocorporativo'] = el)}
                        data-module-id="cerebrocorporativo"
                        className={cardClass}
                        onMouseEnter={() => handleMouseEnter('cerebrocorporativo')}
                        onMouseLeave={handleMouseLeave}
                    >
                        <CerebroCorporativoModule hoveredModule={hoveredModule} moduleId="cerebrocorporativo" />
                    </div>

                    {/* ControlLista - Turquesa */}
                    <div
                        ref={(el) => (moduleRefs.current['controllista'] = el)}
                        data-module-id="controllista"
                        className={cardClass}
                        onMouseEnter={() => handleMouseEnter('controllista')}
                        onMouseLeave={handleMouseLeave}
                    >
                        <ControllistaModule hoveredModule={hoveredModule} moduleId="controllista" />
                    </div>

                    {/* IntelligenceHub - Violeta */}
                    <div
                        ref={(el) => (moduleRefs.current['intelligencehub'] = el)}  
                        data-module-id="intelligencehub"
                        className={cardClass}
                        onMouseEnter={() => handleMouseEnter('intelligencehub')}
                        onMouseLeave={handleMouseLeave}
                    >
                        <IntelligenceHubModule hoveredModule={hoveredModule} moduleId="intelligencehub" />
