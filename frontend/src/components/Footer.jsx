...
const Footer = () => {
    ...
    const hubLogo = { name: 'Hub Digital Coahuila', logo: '/assets/images/hubCoahuila.png', isHub: true };
                            ...
                            <div className="space-y-6 lg:space-y-8 order-1 lg:order-2">
                                ...
                                <div ref={addToSectionRefs} className="text-center lg:text-left">
                                    <div className="mb-4 lg:mb-6 flex justify-center lg:justify-start">
                                        <img 
                                            src="/assets/images/hubCoahuila.png" 
                                            alt="Hub Digital Coahuila" 
                                            className="h-16 md:h-20 lg:h-24 w-auto"
                                        />
                                    </div>
                                    <p className="text-gray-400 text-sm leading-relaxed mb-4 lg:mb-6 max-w-xl mx-auto lg:mx-0">
                                        El ecosistema tecnológico más innovador de Coahuila. Impulsando la transformación digital 
