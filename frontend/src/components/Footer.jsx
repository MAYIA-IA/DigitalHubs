...
const Footer = () => {
    ...
    // 🔧 OPT: el video no se carga hasta que el footer es visible
    const [videoVisible, setVideoVisible] = useState(false);
    
    const scrollToSection = (id) => document.getElementById(id)?.scrollIntoView({ behavior: 'smooth' });
    
    const hubLogo = { name: 'Hub Digital Monterrey', logo: '/assets/images/hubMtyLogo.png', isHub: true };
    ...
    const handleSectionClick = (index) => {
        if (index === selectedIndex) {
            ...
            gsap.to(circleRef.current, { rotation: 0, duration: 0.8, ease: 'power3.inOut' });
        } else {
            const totalSections = partners.length;
            const degreesPerSection = 360 / totalSections;
            const targetRotation = -index * degreesPerSection;
            setSelectedIndex(index);
            gsap.to(circleRef.current, { rotation: targetRotation, duration: 0.8, ease: 'power3.inOut' });
        }
    };

    useEffect(() => {
        // 🔧 OPT: IntersectionObserver para cargar el video solo cuando el footer es visible
        ...
        if (footerEl) videoObserver.observe(footerEl);
    ...
    // 🔧 OPT: cuando el video ya está en el DOM, reproducirlo
    useEffect(() => {
    ...
    return (
        <footer ref={footerRef} className="relative bg-black overflow-hidden">
            {/* 🔧 OPT: video con poster (imagen estática inmediata) y src solo cuando es visible */}
            <div className="absolute inset-0 w-full h-full overflow-hidden">
                {videoVisible ? (
                    <video
                        ...
                        playsInline
                        preload="none"
                        poster="/assets/images/jaguar-poster.webp"
                        className="absolute inset-0 w-full h-full object-cover opacity-20"
                    >
                        <source src="/assets/images/jaguar.mp4" type="video/mp4" />
                    </video>
                ) : (
                    // 🔧 OPT: mientras el footer no es visible, solo muestra el poster (1 imagen, 0 video)
                    <img
                        src="/assets/images/jaguar-poster.webp"
                        alt=""
                        aria-hidden="true"
                        className="absolute inset-0 w-full h-full object-cover opacity-20"
                        // 🔧 OPT: el poster puedes generarlo con: ffmpeg -i jaguar.mp4 -vframes 1 -f image2 jaguar-poster.webp
                        // O usa cualquier frame del video exportado como WebP
                    />
                )}
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start mb-12">
                            ...
                            <div className="space-y-6 lg:space-y-8 order-1 lg:order-2">
                                <div ref={addToSectionRefs} className="text-center lg:text-left">
                                    <div className="mb-4 lg:mb-6 flex justify-center lg:justify-start">
                                        {/* 🔧 OPT: width/height explícitos para evitar layout shift (CLS) */}
                                        <img 
                                            src="/assets/images/hubMtyLogo.png" 
                                            alt="Hub Digital Monterrey" 
                                            width={160}
                                            height={96}
                                    ...
                                    <p className="text-gray-400 text-sm leading-relaxed mb-4 lg:mb-6 max-w-xl mx-auto lg:mx-0">
                                        El ecosistema tecnológico más innovador de Monterrey. Impulsando la transformación digital 
                                ...
                                <div className="grid grid-cols-2 md:grid-cols-3 gap-4 lg:gap-6">
                                    <div ref={addToSectionRefs}>
                                        ...
                                        <ul className="space-y-2">
                                            {navLinks.map((link) => (
                                                <li key={link.id}>
                                                    <button onClick={() => scrollToSection(link.id)} className="text-left w-full">
                                                        <span className="text-gray-400 hover:text-white text-sm transition-colors duration-200">{link.name}</span>
                                                    </button>
                                                </li>
                                            ))}
                                        </ul>
                                    ...
                                    <div ref={addToSectionRefs}>
                                        ...
                                        <button onClick={() => scrollToSection('spaces')} className="text-left w-full group">
                                            <span className="text-gray-400 hover:text-white text-sm transition-colors duration-200">Ver más →</span>
                                        </button>
                                    </div>
                                        ...
                                        <div className="bg-gradient-to-br from-[var(--secundario)]/10 to-[var(--acento)]/5 border border-[var(--secundario)]/30 rounded-lg p-4 hover:border-[var(--secundario)]/50 transition-all duration-300">
                                            ...
                                            <div className="space-y-3 text-xs sm:text-sm">
                                                <div className="space-y-1">
                                                    <a href="mailto:Vviniegra@m2corporativo.com" className="text-white hover:text-[var(--acento)] block transition-colors duration-200 font-medium break-all">
                                                        Vviniegra@m2corporativo.com
                                                    </a>
                                                    <a href="tel:5553315526" className="text-white hover:text-[var(--acento)] block transition-colors duration-200 font-medium flex items-center gap-1">
                                                ...
                                                <div className="space-y-1">
                                                    <a href="mailto:humberto.camacho@rebrights.com" className="text-white hover:text-[var(--acento)] block transition-colors duration-200 font-medium break-all">
                                                        humberto.camacho@rebrights.com
                                                    </a>
                                                    <a href="tel:8115728965" className="text-white hover:text-[var(--acento)] block transition-colors duration-200 font-medium flex items-center gap-1">
                                                        <svg className="w-3 h-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                                                        </svg>
                                                        8115728965
                            ...
                            <div className="flex flex-col items-center justify-center order-2 lg:order-1 lg:sticky lg:top-20">
                                <div className="relative w-[280px] h-[280px] sm:w-[340px] sm:h-[340px] md:w-[400px] md:h-[400px] lg:w-[450px] lg:h-[450px]">
                                    <div ref={circleRef} className="absolute inset-0" style={{ transformOrigin: 'center center' }}>
                                        {selectedIndex !== null && (
                                            <div>
                                                <svg className="absolute inset-0 w-full h-full pointer-events-none" viewBox="0 0 450 450">
                                                    <path
                                                        ...
                                                        strokeWidth="2"
                                                        onClick={() => { setSelectedIndex(null); gsap.to(circleRef.current, { rotation: 0, duration: 0.8, ease: 'power3.inOut' }); }}
                                                ...
                                                >
                                                    <div className="relative group">
                                                        ...
                                                        <img src={hubLogo.logo} alt={hubLogo.name} width={96} height={96} loading="lazy" decoding="async" className="relative w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain opacity-80 group-hover:opacity-100 group-hover:scale-110 transition-all duration-300 drop-shadow-[0_0_15px_rgba(72,129,235,0.6)]" />
                                                    </div>
                                                </div>
                                            </div>
                                        )}
                                        ...
                                        {partners.map((partner, index) => {
                                            ...
                                            return (
                                                <div key={partner.name}>
                                                    ...
                                                    <div
                                                        className="absolute top-1/2 left-1/2 cursor-pointer z-10"
                                                        style={{ transform: `translate(-50%, -50%) translate(${x}px, ${y}px) rotate(${-angle + 90}deg)` }}
                                                        onClick={() => handleSectionClick(index)}
                                                    >
                                                        <div className="relative group">
                                                            <div className="absolute inset-0 bg-[var(--acento)] rounded-full blur-xl opacity-30 group-hover:opacity-60 transition-opacity duration-300"></div>
                                                            {/* 🔧 OPT: lazy load en logos del footer (están debajo del fold) */}
                                                            <img src={partner.logo} alt={partner.name} width={96} height={96} loading="lazy" decoding="async" className="relative w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain opacity-80 group-hover:opacity-100 group-hover:scale-110 transition-all duration-300 drop-shadow-[0_0_15px_rgba(72,129,235,0.6)]" />
                                                        </div>
                                                    </div>
                                                </div>
                                            );
                                    ...
                                    >
                                        <div className="relative">
                                            ...
                                            <div className="relative w-28 h-28 sm:w-32 sm:h-32 md:w-36 md:h-36 lg:w-44 lg:h-44 bg-gradient-to-br from-[#0D1B2A] via-[#1B263B] to-[#0D1B2A] rounded-full border-4 border-[var(--secundario)]/70 group-hover:border-[var(--acento)] shadow-[0_0_50px_rgba(72,129,235,0.5)] group-hover:shadow-[0_0_70px_rgba(127,209,255,0.7)] flex items-center justify-center overflow-hidden transition-all duration-500 group-hover:scale-105">
                                                ...
                                                <img 
                                                    src={selectedIndex !== null ? partners[selectedIndex].logo : hubLogo.logo}
                                                    alt={selectedIndex !== null ? partners[selectedIndex].name : hubLogo.name}
                                                    width={144}
                                                    height={144}
                                                    loading="lazy"
                                                    decoding="async"
                        ...
                        <div className="pt-8 border-t border-white border-opacity-10">
                            <div className="flex flex-col md:flex-row justify-between items-center gap-4">
                                <div className="flex flex-col sm:flex-row items-center gap-3">
                                    <img src="/assets/images/hechoMexicoRojo.PNG" alt="Hecho en México" width={80} height={40} loading="lazy" decoding="async" className="h-10 w-auto opacity-70" />
                                    <p className="text-gray-500 text-xs">© 2026 Hub Digital Monterrey</p>
                                </div>
