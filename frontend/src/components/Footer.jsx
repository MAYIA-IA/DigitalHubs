...
const Footer = () => {
    ...
    const partners = [
        ...
        { name: 'AMED', logo: '/assets/images/amedLogo.jpeg', isHub: false },
                            ...
                            <div className="space-y-6 lg:space-y-8 order-1 lg:order-2">
                                <div ref={addToSectionRefs} className="text-center lg:text-left">
                                    ...
                                    <p className="text-gray-400 text-sm leading-relaxed mb-4 lg:mb-6 max-w-xl mx-auto lg:mx-0">
                                        El ecosistema tecnológico más innovador de León. Impulsando la transformación digital 
                                    ...
                                    <div ref={addToSectionRefs} className="col-span-2 md:col-span-1">
                                        <div className="bg-gradient-to-br from-[var(--secundario)]/10 to-[var(--acento)]/5 border border-[var(--secundario)]/30 rounded-lg p-4 hover:border-[var(--secundario)]/50 transition-all duration-300">
                                            ...
                                            <div className="space-y-3 text-xs sm:text-sm">
                                                ...
                                                <div className="space-y-1">
                                                    <a href="mailto:marcosreyes.vargas@gmail.com" className="text-white hover:text-[var(--acento)] block transition-colors duration-200 font-medium break-all">
                                                        marcosreyes.vargas@gmail.com
                                                    </a>
                                                    <a href="tel:+524772319055" className="text-white hover:text-[var(--acento)] block transition-colors duration-200 font-medium flex items-center gap-1">
                                                        <svg className="w-3 h-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                                                        </svg>
                                                        +52 47723 19055
                        ...
                        <div className="pt-8 border-t border-white border-opacity-10">
                            <div className="flex flex-col md:flex-row justify-between items-center gap-4">
                                <div className="flex flex-col sm:flex-row items-center gap-3">
                                    ...
                                    <p className="text-gray-500 text-xs">© 2026 Hub Digital León</p>
                                </div>
